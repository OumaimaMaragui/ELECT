...
class Moyenne extends Command
{
     ...
     * @var string
     */
    protected $signature = 'moyenne:send';
    ...
    public function handle()
    {
      ...
      // Consommation des jours précedents pour faire la moyenne
        ...
        if($moyenne < $consommation){
          ...
          $noti->user_id = $uu;
          $noti->type = 'alerte';
          $noti->texte = "La consommation d'hier ".$date." est ".$consommation." . Elle dépasse la consommation moyenne".$moyenne. ". Essayer d'etre plus economique!";
